...
export const createZustandStore = <S, A>(storeInitializer: StoreInitializer<S, A>,preloadedState: Partial<S>)=> createStore<ZustandStore<S, A>>((set, get) =>
  storeInitializer(set, get, preloadedState)
);
